...
/**
 * Created by Dev_am1 on 2/14/2020
 * <p>
...
public class AppProvider extends ContentProvider {
    ...
    static final String CONTENT_AUTHORITY = "com.amirmoradi.tasktimer.provider";
    public static final Uri CONTENT_AUTHORITY_URI = Uri.parse("content://" + CONTENT_AUTHORITY);

    private static final int TASKS = 100;
    private static final int TASKS_ID = 10;
    ...
    private static UriMatcher buildUriMatcher() {
        ...
        //e.g. content://com.amirmoradi.tasktimer.provider/Tasks
        matcher.addURI(CONTENT_AUTHORITY, TasksContract.TABLE_NAME, TASKS);
        //e.g. content://com.amirmoradi.tasktimer.provider/Tasks/8
...
//                queryBuilder.appendWhere(TimingsContract.Coluns._ID + "=" + timingId);
//                break;
//            case TASK_DURATION :
